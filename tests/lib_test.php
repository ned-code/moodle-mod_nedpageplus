...
/**
 * Unit tests for mod_nedpageplus lib
 *
 ...
 * @since      Moodle 3.0
 */
class mod_nedpageplus_lib_testcase extends advanced_testcase {
    ...
    public function test_nedpageplus_view(){
        ...
        $moodleurl = new \moodle_url('/mod/nedpageplus/view.php', array('id' => $cm->id));
    ...
    public function test_nedpageplus_core_calendar_provide_event_action(){
        ...
        $actionevent = mod_nedpageplus_core_calendar_provide_event_action($event, $factory);
