...
/**
 * External mod_nedpageplus functions unit tests
 *
 ...
 * @since      Moodle 3.0
 */
class mod_nedpageplus_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_view_page() {
        ...
        $page = $this->getDataGenerator()->create_module('nedpageplus', array('course' => $course->id));
        ...
        $result = mod_nedpageplus_external::view_page($page->id);
        $result = external_api::clean_returnvalue(mod_nedpageplus_external::view_nedpageplus_returns(), $result);
        ...
        $this->assertInstanceOf('\mod_nedpageplus\event\course_module_viewed', $event);
        $this->assertEquals($context, $event->get_context());
        $moodlepage = new \moodle_url('/mod/nedpageplus/view.php', array('id' => $cm->id));
        ...
        assign_capability('mod/nedpageplus:view', CAP_PROHIBIT, $studentrole->id, $context->id);
    ...
    public function test_mod_nedpageplus_get_pages_by_courses() {
        ...
        $page1 = self::getDataGenerator()->create_module('nedpageplus', $record);

        // Second page.
        $record = new stdClass();
        $record->course = $course2->id;
        $page2 = self::getDataGenerator()->create_module('nedpageplus', $record);
        ...
        $returndescription = mod_nedpageplus_external::get_pages_by_courses_returns();
        ...
        $result = mod_nedpageplus_external::get_pages_by_courses(array($course2->id, $course1->id));
        ...
        $result = mod_nedpageplus_external::get_pages_by_courses(array($course2->id));
