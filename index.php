...
$event = \mod_nedpageplus\event\course_module_instance_list_viewed::create(['context' => context_course::instance($course->id)]);
...
$PAGE->set_url('/mod/nedpageplus/index.php', ['id' => $course->id]);
