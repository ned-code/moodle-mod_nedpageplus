 ...
 */
class moodle1_mod_nedpageplus_handler extends moodle1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_nedpageplus');
