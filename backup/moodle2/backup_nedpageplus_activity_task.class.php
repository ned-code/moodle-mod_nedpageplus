...
/**
 * Defines backup_nedpageplus_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/nedpageplus/backup/moodle2/backup_nedpageplus_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the Page instance
 */
class backup_nedpageplus_activity_task extends backup_activity_task {
